      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="border-t p-4 bg-gray-50">
            ...
            <button
              className="w-full bg-orange-500 text-white py-3 px-4 rounded-lg hover:bg-orange-600 transform hover:scale-[1.02] transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center justify-center space-x-2"
              onClick={() => {

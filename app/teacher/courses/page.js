  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        alert(`Failed to ${editingCourse ? 'update' : 'create'} course: ${data.message}`);
      }
    } catch (error) {
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                  >

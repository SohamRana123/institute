        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 4 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 120</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 3 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 100</p>
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 3 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 80</p>
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                <span className="text-blue-600 font-medium">3 Years</span>
                <Link
                  href="/apply"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 4 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 150</p>
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                <span className="text-blue-600 font-medium">4 Years</span>
                <Link
                  href="/apply"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 5 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 60</p>
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 border-t-4 border-blue-500">
              ...
              <p className="text-gray-800 mb-1">Duration: 3 Years</p>
              <p className="text-gray-800 mb-6">Available Seats: 40</p>
              <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                <span className="text-blue-600 font-medium">3 Years</span>
                <Link
                  href="/apply"
